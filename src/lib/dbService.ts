...
export const dbService = {
  ...
  async getProfile(forceRefresh = false) {
    ...
    try {
      ...
      const profileData = {
        ...
        origin_postal_code: user.user_metadata?.origin_postal_code || data?.origin_postal_code || user.user_metadata?.sender_postal_code || data?.sender_postal_code || '',
        sender_postal_code: user.user_metadata?.sender_postal_code || data?.sender_postal_code || user.user_metadata?.origin_postal_code || data?.origin_postal_code || '',
  ...
  async getOwnerId() {
    ...
    if (_cachedProfile) {
      ...
      if (_cachedProfile.role !== 'tratador' && _cachedProfile.id) {
